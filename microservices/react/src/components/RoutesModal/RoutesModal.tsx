     ...
     <div className="modal-content">
               ...
               {savedRoutes.map((route) => (
                 ...
                 >
                   <div className="route-info">
                     <h3>{route.label}</h3>
                     <p><strong>From:</strong> {route.startingLocation}</p>
                     <p><strong>To:</strong> {route.endingLocation}</p>
                     <p><strong>Time:</strong> {formatTime(route.pickupTime)}</p>
                   </div>
       ...
       {step === "confirm" && currentRoute && (
         <>
           ...
           <button className="submit-button" onClick={handleSaveRoute} disabled={hasSaved}>
             Save Route
           </button>
           {mode === "find" && (
